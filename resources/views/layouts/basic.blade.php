...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href=" {{ asset('lib/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css') }}">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand sticky_logo" href="index3.html"><img src="images/logo-white.png"
                                                                                    class="logo" alt=""></a>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer_panel bottom30">
                    ...
                    <ul class="area_search">
                        ...
                        <li class="active"><a href="javascript:void(0)"><i class="icon-icons74"></i>Greenville, New
                                Jersey</a></li>
