            ...
            <div class="property-form">
                ...
                <div class="box-body ">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control initial-input" type="text" name="title" value="{{ old('title') }} ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control last-input-item pull-right" name="available_from" id="datepicker">
                        </div>
                        <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control last-input-item" type="text" name="address_city" value="{{ old('address_city') }} ">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="exampleInputFile" class="last-input-item">
                    </div>
