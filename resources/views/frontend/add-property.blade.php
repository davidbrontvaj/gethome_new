    ...
    <div class="row">
          ...
          <div class="col-sm-1 col-md-2"></div>
           ...
           <div class="col-sm-10 col-md-8">
                ...
                <form role="form" method="POST" action="add-property" class="callus clearfix border_radius submit_property rounded-box">
                    ...
                    <div class="divider"></div>
                     ...
                     <div class="form-group">
                        ...
                        <label for="disposition" class="control-label">Dispozícia bytu</label>
                          ...
                          <div class="intro"> 
                        <select>
                          <option class="active">Vybrať dispozíciu</option>
